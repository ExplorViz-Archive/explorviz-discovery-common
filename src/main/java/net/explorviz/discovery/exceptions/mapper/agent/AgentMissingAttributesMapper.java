...
public class AgentMissingAttributesMapper implements ExceptionMapper<AgentMissingAttributesException> {
	...
	public Response toResponse(final AgentMissingAttributesException exception) {
		...
		final byte[] errorObject = ErrorObjectHelper.getInstance().createSerializedErrorArray(
				ResponseUtil.HTTP_STATUS_UNPROCESSABLE_ENTITY, ResponseUtil.ERROR_AGENT_MISSING_ATTRIBUTES_TITLE,
