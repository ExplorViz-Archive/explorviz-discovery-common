...
public class ResponseUtil {
	...
	public static final String UNEXCPECTED_ERROR_USER_NOTIFICATION = "This should not happen at this stage. Notify a developer. ";
	...
	public static final String ERROR_PROCEZZ_START_NOT_FOUND = "Couldn't find it in new procezzList from OS. Check User- (if not declared: OS) Exec CMD. The execution command might be wrong";
	...
	public static final String ERROR_PROCEZZ_TYPE_INCOMPATIBLE_COMP = "ProcezzManagementType of two procezzes does not match. ";

	public static final String ERROR_PROCEZZ_TYPE_NOT_FOUND_TITLE = "ProcezzManagementType not found.";
	public static final String ERROR_PROCEZZ_TYPE_NOT_FOUND_DETAIL = "No ProcezzManagementType found for the passed key, therefore it cannot be re-found after restart. ";
